...
이번 2학년 1학기는 군 제대 이후 복학 시즌이였고, 1학기 수강신청을 준비 하던 도중 수강해야 하는 과목중에 코딩, 프로그래밍이라는 단어를 보자마자 자동으로 몸서리 치던느낌이 아직도 생생하다. 하지만 미디어소프트웨어학과 라는 공대 학과를 희망하고 선택해서 들어온 이상 피해갈 수도 없는 현실이였다.
게다가 웹 프로그래밍은 정말 처음보고 처음 듣는것이였어서, 걱정만 절반 이상 품은 채로 시작했던 것 같다.
수업의 내용이자 목표는 말 그대로 웹 페이지를 프로그래밍 해서 구현하는 것이였고, 우리에게 친숙한 롤 홈페이지를 구현하는 것이 최종 목표였다.
걱정과는 다르게 수업자료들이 보고 따라올 수 있을만큼 매주마다 꼼꼼하게 준비되어있었고, 수업 진행 도중 뒤처진 학생들을 교수님께서 빠짐없이 잘 챙겨주셨다. 특히 나같은 경우는 도중에 빵꾸가 많이 났었는데, 물어볼때마다 친절하게 알려주신 덕분에 두려움보다는 에러를 해결하고싶다는 생각이 먼저 들었다. 그 결과 오류 없이 잘 작동되는 웹페이지를 학기 마무리까지 잘 구현할 수 있었다.

중간고사 시즌까지는 여전히 어려움을 느끼고, 공부를 어떻게 해야할지도 막막했어서 만족스러운 결과가 나오지 않았다.
그래서 기말고사를 준비하기까지는 보고 따라하는거에서 끝나는 것이 아니라, 수업 도중 이해가 안갔던 부분은 AI를 통해 자습을 하고 정리도 해보았다.
주마다 '어떤 부분의 구현'의 이름으로 잘 정리되어있는 수업 자료 덕분에 AI에게 질문하기도 수월했다. 
AI는 내가 원하는 형식대로 깔끔하게 쉬운 비유와 함께 정리를 잘 해주었다.
언제 무슨 함수가 로그인 구현에 왜 필요한지, 무슨 역할인지 학기 초에 비해 잘 학습이 되는 느낌이였다.
내가 했던 코딩들을 보고, 대략적인 구조와 함수의 역할들을(전부는 아니더라도 간략하게나마) 파악할 수 있는 눈을 기르게 되었다.
그렇게 기말고사땐 중간고사에 비해 더 많은 답을 채워넣을 수 있게 되었다.

학기 초에 뒤처지는걸 알고 있음에도, 두려움에 회피를 한것이 조그만 후회로 남는다.
조금 더 일찍 용기를 내서 이 학습방법을 시도해봤다면 어땠을까 하는 아쉬움도 남는다.
하지만 이 수업에서 배운것(html 구현)을 통해 다른 과목 과제에 활용도 해보았고, 분명히 배우면서 얻어간 것은 있었다.
또한 '프로그래밍' 이라는 것에 대한 두려움을 나의 내면에서 한단계 걷어낼 수 있었던 유용한 과목이였던것 같다.

6.17 
++
보고서 제출이 제 부주의로 미스가 났는데 기회를 주셔서 정말 감사합니다 교수님!!
